...
def load():
    raw_data = pd.read_csv("/Users/aimlessfox/Desktop/Projects/EL Weather Analysis/weather_EL.csv")
    cleaned = pd.read_csv("/Users/aimlessfox/Desktop/Projects/EL Weather Analysis/weather_EL_cleaned.csv")
